<?php
final class sptactController extends tmssController {
  const CONTROLLER = 'sptact';
	const MODEL = 'sptact';							
	const VIEW  = 'sptact';							
	const ID = 'actcod';								
	protected $co_reg;
    ...
    switch( $lp_act ) {
      ...
      case '#00': 
        ...
        if ( $this->lo_mdl->save( $lo_post ) ) {
					$this->lo_mdl->load( array(	'actcod'=>$this->lo_mdl->actcod	) );				
      ...
      case '#17':
				$lv_prm = array('vewmaxrec' =>'10',
												'vewfldflt' => (isset($lp_prm['acttxt'])?'[~fltrow~]a.acttxt'.chr(9).''.chr(9).($lp_prm['acttxt']).chr(9).chr(9).chr(9):'').
