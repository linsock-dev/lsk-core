<?php
final class hhrwrksteController extends tmssController {
	const CONTROLLER = 'hhrwrkste';
	const MODEL = 'hhrwrkste';
	const VIEW  = 'hhrwrkste';
	const ID = 'wrkstecod';
    ...
    switch( $lp_act ) {
      ...
      case '#00':
        ...
        if ( $this->lo_mdl->save( $lo_post ) ) {
					$this->lo_mdl->load( array(	self::ID=>$this->lo_mdl->wrkstecod	) );
      ...
      case '#18':
				$lv_prm = array('vewmaxrec' =>'10',
												'vewfldflt' => (isset($lp_prm['wrkstetxt'])?'[~fltrow~]s.wrkstetxt'.chr(9).''.chr(9).$lp_prm['wrkstetxt'].chr(9).chr(9).chr(9):'').
