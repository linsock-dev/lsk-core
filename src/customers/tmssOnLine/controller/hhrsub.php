<?php
final class hhrsubController extends tmssController {
	const CONTROLLER = 'hhrsub';
	const MODEL = 'hhrsub';
	const VIEW  = 'hhrsub';
	const ID = 'hhrsubcod';
    ...
    switch( $lp_act ) {
      ...
      // SAVE
        ...
        if ( $this->lo_mdl->save( $lo_post ) ) {
					$this->lo_mdl->load( array(	self::ID=>$this->lo_mdl->hhrsubcod	) );				// ********************
        ...
        break;
			...
			case '#18':
				$lv_prm = array('vewmaxrec' =>'10',
												'vewfldflt' => (isset($lp_prm['hhrsubtxt'])?'[~fltrow~]hhrsubtxt'.chr(9).''.chr(9).$lp_prm['hhrsubtxt'].chr(9).chr(9).chr(9):'').
