<?php
final class grladrlndController extends tmssController {
  
	const MODEL = 'grladrlnd';						// **************************
	const VIEW  = 'grladrlnd';						// **************************
	const ID = 'lndcod';									// **************************
  protected $co_reg;
	private $lo_mdl;
  private $data = array();
        ...
        break;
			...
			case '#18':
				$lv_prm = array('vewmaxrec' =>'10',
												'vewfldflt' => (isset($lp_prm['lndtxt'])?'[~fltrow~]l.lndtxt'.chr(9).''.chr(9).$lp_prm['lndtxt'].chr(9).chr(9).chr(9):'').
