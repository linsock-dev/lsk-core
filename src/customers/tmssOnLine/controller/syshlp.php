<?php
final class syshlpController extends tmssController {
  ...
  public function index( $lp_act , $lp_prm = array() ) {
    ...
    switch( $lp_act ) {
      ...
      case '#00':        
        if ( $this->lo_mdl->save() ) {
					$this->lo_mdl->load( array(	'syshlpcod'=>$this->lo_mdl->syshlpcod	) );											// ********************
					return $this->getView();
        } else {
      ...
      case '#04':
        ...
        break;
			...
			case '#99':
				...
				$lv_buffer = 	$this->co_reg->load->view('sysdochdr', $lv_prm) .
											$this->co_reg->load->view('syshlpshw', $lv_prm) .
											$this->co_reg->load->view('sysdocftr', $lv_prm);
				return $lv_buffer;
				break;
