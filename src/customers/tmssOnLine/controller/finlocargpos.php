<?php
final class finlocargposController extends tmssController {
	const MODEL = 'finlocargpos';						
	const VIEW  = 'finlocargpos';						
	const ID = 'argposcod';									
  protected $co_reg;
	private $lo_mdl;
  private $data = array();
  ...
  public function index( $lp_act , $lp_prm = array() ) {
    ...
    switch( $lp_act ) {
      ...
      case '#00':
        if ( $this->lo_mdl->save() ) {
					$this->lo_mdl->load( array(self::ID=>$this->lo_mdl->argposcod) );
