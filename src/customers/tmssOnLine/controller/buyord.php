<?php
final class buyordController extends tmssController {
	const CONTROLLER = 'buyord';
	const MODEL = 'buyord';
	const VIEW  = 'buyord';
	const ID = 'buyordcod';
    ...
    switch( $lp_act ) {
      ...
      case '#04':
        ...
        break;
			...
			// MATERIALES. lista de materiales de pedidos
      case '#08_mat':
        $lo_vew = $this->co_reg->load->controller('grlvew');
        $lp_prm['controller'] = 'buyord';
        $lp_prm['model'] = 'buyordmat';
				if(!isset($lp_prm['vewfldflt'])){$lp_prm['vewfldflt']='';}
