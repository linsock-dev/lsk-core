<?php
	...
	/* url del formulario */
  $lv_lnk = "?prg=slsord&prm_slsordcod=".$vew_data->slsordcod;
...
<section id="<?= $lv_sec; ?>" data-title="<?= $lv_title; ?>">
  ...
  <form method="POST" class="form-horizontal tmss-form-horizontal" id="<?= $lv_sec; ?>_frm">
    ...
    <div class="container-fluid" role="tabpanel"> 
        ...
        <?php
        	if($vew_data->prcschcod != ''){
        		echo '<li role="presentation"><a href="#'.$lv_sec.'_tab002" role="tab" data-toggle="tab">'.$vew_lang->prices.'</a></li>';
          }
        ?>
				<li class="pull-right"><h4># <strong><?= $vew_data->slsordcod.'/'.$vew_data->slsordmatcod; ?><input type="hidden" id="slsordcod" name="slsordcod" value="<?= $vew_data->slsordcod; ?>"><input type="hidden" id="slsordmatcod" name="slsordmatcod" value="<?= $vew_data->slsordmatcod; ?>"></strong></h4></li>
			</ul>
			<div class="tab-content tmss-tab-content">
				...
				<div role="tabpanel" class="tab-pane active" id="<?= $lv_sec; ?>_tab001">						
					<?php
						echo vew_boot($lv_col210, array('label'=>$vew_lang->salestext,	'input'=>gethtml('slsordmatslstxt',	'doccmt1x250', $vew_data->slsordmatslstxt, $lv_default) ));
