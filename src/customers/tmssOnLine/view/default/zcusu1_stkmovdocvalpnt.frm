<?php
  ...
  for($i=0; $i<$vew_msgqty; $i++){
    ...
    $pdf->text( 182, 5, ($lv_srcobjtyp=='stk_sou'?'-047-SS':'-069-SS') );
    $pdf->text( 201, 5, '00' );
    ...
    $pdf->text( 102, 16, ($lv_srcobjtyp=='stk_sou'?'V-SAL':"INGRE"));
    $pdf->setfont('helvetica', 'B', 9);
    $pdf->text( 156, 9, ($lv_srcobjtyp=='stk_sou'?'VALE DE SALIDA':'INGRESO DE MATERIALES'));
