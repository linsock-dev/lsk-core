<?php
	/* url del formulario */
  $lv_lnk = "?prg=slsinv&prm_slsinvcod=".$vew_data->slsinvcod;
  ...
  <form method="POST" class="form-horizontal tmss-form-horizontal" id="<?= $lv_sec; ?>_frm">
    ...
    <div class="container-fluid" role="tabpanel"> 
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class="pull-right"><h4># <strong><?= $vew_data->slsinvcod.'/'.$vew_data->slsinvmatcod; ?><input type="hidden" id="slsinvcod" name="slsinvcod" value="<?= $vew_data->slsinvcod; ?>"><input type="hidden" id="slsinvmatcod" name="slsinvmatcod" value="<?= $vew_data->slsinvmatcod; ?>"></strong></h4></li>
			</ul>
			<div class="tab-content tmss-tab-content">
				...
				<div role="tabpanel" class="tab-pane active" id="<?= $lv_sec; ?>_tab001">						
					<?php
						echo vew_boot($lv_col210, array('label'=>$vew_lang->salestext,	'input'=>gethtml('slsinvmatslstxt',	'doccmt1x250', $vew_data->slsinvmatslstxt, $lv_default) ));
