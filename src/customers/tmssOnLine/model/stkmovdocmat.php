<?php
final class stkmovdocmat extends tmssAction {
  protected $co_reg;
  private $data = array();
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array(), $lo_vew=null ) {
	...
	private function call_sp( $lp_action, $lp_in, &$lp_out ) {
		...
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			...
																			$this->co_reg->db->sqldat($lp_in,'stkmovdocmatcod'), 
																			...
																			$this->co_reg->db->sqldat($lp_in,'matsercodext',false),
																			...
																			$this->co_reg->db->sqlnum($lp_in,'matqtypck'),
																			$this->co_reg->db->sqldat($lp_in,'matuntcodpck'),
                                     	$this->co_reg->db->sqldat($lp_in,'sysdocrsncod')
																		);
		$this->sysdata['sqltxt'] = 'STK_MOV_DOC_MAT_DEF (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
