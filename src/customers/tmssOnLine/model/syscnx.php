<?php
final class syscnx extends tmssAction {
  protected $co_reg;
  private $data = array();
  ...
  //  CALL SP. llamada a base de datos
	private function call_sp( $lp_action, $lp_in, &$lp_out ) {
		...
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, 
                                     	$this->co_reg->db->sqldat($lp_in, 'syscnxcod'),
                                     	$this->co_reg->db->sqldat($lp_in, 'syscnxcodext'),
                                     	$this->co_reg->db->sqldat($lp_in, 'syscnxcodtxt'),
																			$this->co_reg->db->sqldat($lp_in, 'docsts'),
                                     	$this->co_reg->db->sqldat($this->sysdata, 'view_options',false)
                                    );
		$this->sysdata['sqltxt'] = 'SYS_CNX_DEF (?,?,?,?,?,null,null,null,null,null,?,?)';
