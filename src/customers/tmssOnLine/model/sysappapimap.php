<?php
final class sysappapimap extends tmssAction {
  protected $co_reg;
  private $data = array();
	private $sysdata = array();
	const ID = 'sysappapimapcod';
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array() ) {
    ...
    $this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, 
																			$this->co_reg->db->sqldat($lp_in,'sysappapimapcod'),
																			$this->co_reg->db->sqldat($lp_in,'sysappapicod'),
                                     	$this->co_reg->db->sqldat($lp_in,'sysappapimapmth'), 
																			$this->co_reg->db->sqldat($lp_in,'sysappapimapvar'),
																			$this->co_reg->db->sqldat($lp_in,'sysappapimapfldcod'), 
                                     	$this->co_reg->db->sqldat($lp_in,'sysappapimapmdl'),
                                     	$this->co_reg->db->sqldat($lp_in,'sysappapimapmdlmth'),
                                     	$this->co_reg->db->sqldat($lp_in,'sysappapimapfldmap',false),
																			$this->co_reg->db->sqldat($lp_in,'docsts'),
																			$this->co_reg->db->sqldat($this->sysdata,'view_options',false),
																		);
    $this->sysdata['sqltxt'] = 'SYS_APP_API_MAP_DEF (?,?,?,?,?,?,?,?,?,?,?,?)';
