<?php
final class tsrmovdoccmp extends tmssAction {
  protected $co_reg;
  private $data = array();
	private $sysdata = array();
	const ID = 'tsrmovdoccmpcod';
  ...
  function save( $lp_dat=array() ) {
    ...
    $this->data['tsrmovdoccmpatr'] = '<tsrmovdoccmptxt>'.(isset($this->data['tsrmovdoccmptxt'])?utf8_encode(htmlentities($this->data['tsrmovdoccmptxt'])):'').'</tsrmovdoccmptxt>';
    $lo_out_data = array();
