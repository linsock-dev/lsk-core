<?php
final class logtrarouzon extends tmssAction {
  protected $co_reg;
  private $data = array();
	private $sysdata = array();
	const ID = 'trarouzoncod';
	const SRCTYP = 'LOG_ROU_ZON';		                                                                                                                         // ************************************** 
