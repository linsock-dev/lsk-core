<?php
final class tsrcsh extends tmssAction {
  protected $co_reg;
  private $data = array();
	private $sysdata = array();
	const ID = 'cshcod';
  const OBJTYP = 'TSR_CSH';
	...
	private function call_sp( $lp_action, $lp_in, &$lp_out ) {
		...
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod,
                                     	$this->co_reg->db->sqldat($lp_in,'cshcod'),
																			$this->co_reg->db->sqldat($lp_in,'cshcodext'),
                                      $this->co_reg->db->sqldat($lp_in,'cshtxt'),
																			$this->co_reg->db->sqldat($lp_in,'docsts'),
                                     	$this->co_reg->db->sqldat($this->sysdata,'view_options',false)
                                    );
		$this->sysdata['sqltxt'] = 'TSR_CSH_DEF (?,?,?,?,?,?,?,?)';
