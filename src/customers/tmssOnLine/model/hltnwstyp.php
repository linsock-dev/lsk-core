<?php 
final class hltnwstyp extends tmssAction {
  protected $co_reg;
  private $data = array();
  ...
  //  CALL SP. llamada a base de datos
	private function call_sp( $lp_action, $lp_in, &$lp_out ) {
		...
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			$this->co_reg->db->sqldat($lp_in,'hltnwstypcod'), 
                                     	$this->co_reg->db->sqldat($lp_in,'hltnwstypcodext'), 
																			$this->co_reg->db->sqldat($lp_in,'hltnwstyptxt',false),
                                      $this->co_reg->db->sqldat($lp_in,'buyexptypcod'), 
                                     	$this->co_reg->db->sqldat($lp_in,'docsts'),
																			$this->co_reg->db->sqldat($this->sysdata,'view_options',false)
																		);
		$this->sysdata['sqltxt'] = 'HLT_NWS_TYP_DEF (?,?,?,?,?,?,?,?,?)';
