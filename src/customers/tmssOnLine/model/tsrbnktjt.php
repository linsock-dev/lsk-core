<?php
final class tsrbnktjt extends tmssAction {
  protected $co_reg;
  private $data = array();
  ...
  //  CALL SP. llamada a base de datos
	private function call_sp( $lp_action, $lp_in, &$lp_out ) {
		...
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			...
																			$this->co_reg->db->sqldat($lp_in,'bnktjtcodext'), 
																			$this->co_reg->db->sqldat($lp_in,'bnktjttxt'),
                                      $this->co_reg->db->sqldte($lp_in,'bnktjtstrdte'),
                                      $this->co_reg->db->sqldte($lp_in,'bnktjtenddte'),
                                     	$this->co_reg->db->sqldte($lp_in,'bnktjtsrcdte'),
                                      $this->co_reg->db->sqldat($lp_in,'bnktjttyp'),
																			$this->co_reg->db->sqldat($lp_in,'docsts');
		$this->sysdata['sqltxt'] = 'TSR_BNK_TJT_DEF (?,?,?,?,?,?,?,?,?,?,?)';
