<?php
final class sptact extends tmssAction {
  protected $co_reg;
  private $data = array();
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array(), $lo_vew=null, $lp_authCheck=true ) {
    ...
    $lv_buscod = (isset($this->sysdata['buscod'])?$this->sysdata['buscod']:$this->co_reg->sec->buscod);
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $lv_buscod, 
                                     $this->co_reg->db->sqldat($lp_in,'actcod'),
                                     $this->co_reg->db->sqldat($lp_in,'actcodext'),
                                     $this->co_reg->db->sqldat($lp_in,'acttxt'),
                                     $this->co_reg->db->sqldat($lp_in,'actrsptxt'),
                                     $this->co_reg->db->sqldat($lp_in,'actloctxt'),
                                     $this->co_reg->db->sqldat($lp_in,'actsex'),
                                     $this->co_reg->db->sqldat($lp_in,'actagestr'),
                                     $this->co_reg->db->sqldat($lp_in,'actageend'),
                                     $this->co_reg->db->sqldat($lp_in,'actatr'),
                                     $this->co_reg->db->sqldat($lp_in,'spttrfcod'),
                                     $this->co_reg->db->sqldat($lp_in,'actgrptxt'),
                                     $this->co_reg->db->sqldat($lp_in,'tchcod'),
                                     $this->co_reg->db->sqldat($lp_in,'docsts'),
                                     $this->co_reg->db->sqldat($this->sysdata,'view_options', false)   
																		);
		$this->sysdata['sqltxt'] = 'SPT_ACT_DEF (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
