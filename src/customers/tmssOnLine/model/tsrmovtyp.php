<?php
final class tsrmovtyp extends tmssAction {
  protected $co_reg;
  private $data = array();
	private $sysdata = array();
	const ID = 'tsrmovtypcod';
	const OBJTYP = 'TSR_TYP';
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array() ) {
    ...
    $this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			...
																			$this->co_reg->db->sqldat($lp_in,'tsrmovtypcodext'), 
																			$this->co_reg->db->sqldat($lp_in,'tsrmovtyptxt'),
                                     	$this->co_reg->db->sqldat($lp_in,'tsrmovtypblc'), 
                                     	$this->co_reg->db->sqldat($lp_in,'finacccod'), 
																			$this->co_reg->db->sqldat($lp_in,'docsts'),
																			$this->co_reg->db->sqldat($this->sysdata,'view_options',false)
																		);
    $this->sysdata['sqltxt'] = 'TSR_MOV_TYP_DEF (?,?,?,?,?,?,?,?,?,?)';
