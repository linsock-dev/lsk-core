<?php
final class grldocflwpos extends tmssAction {
  protected $co_reg;
  private $data = array();
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array(), $lo_vew=null) {
	...
	private function call_sp( $lp_action, $lp_in, &$lp_out ) {
		...
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			...
																			$this->co_reg->db->sqldat($lp_in,'refposcod'),  
																			$this->co_reg->db->sqldat($lp_in,'refposqty'),  
																			$this->co_reg->db->sqldat($lp_in,'refposuntcod'),
                                     	$this->co_reg->db->sqldat($lp_in,'srcobjclscod'),
                                     	$this->co_reg->db->sqldat($lp_in,'refobjclscod'),
																			$this->co_reg->db->sqldat($lp_in,'docsts'), 
																			$this->co_reg->db->sqldat($this->sysdata,'view_options',false)
																		);
		$this->sysdata['sqltxt'] = 'GRL_DOC_FLW_POS_DEF (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
