<?php
final class buyreq extends tmssAction2 {
  ...
  function accounting( $lp_dat=array() ) {
    $lo_dat = (count($lp_dat)>0?$lp_dat:$this->co_reg->request->post);
		$this->data = $lo_dat;
		$lo_out_data = array();
		return $this->call_sp( '09', $this->data, $lo_out_data ); // contabilizar no se validan permisos??
  }
