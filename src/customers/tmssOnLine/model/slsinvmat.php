<?php
final class slsinvmat extends tmssAction {
  protected $co_reg;
  private $data = array();
	private $sysdata = array();
	const ID = 'slsinvmatcod';
  const SRCTYP = 'SLS_INV_MAT';
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array(), $lo_vew=null ) {
	...
	private function call_sp( $lp_action, $lp_in, &$lp_out ) {
		...
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			...
																			$this->co_reg->db->sqldat($lp_in,'slsinvmatcod'), 
																			...
																			$this->co_reg->db->sqldat($lp_in,'slsinvmatatr',false),
		...
		$this->sysdata['sqltxt'] = 'SLS_INV_MAT_DEF (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
