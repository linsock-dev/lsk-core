<?php
final class sysapppryapi extends tmssAction {
  protected $co_reg;
  private $data = array();
	private $sysdata = array();
	const ID = 'sysapppryapicod';
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array() ) {
    ...
    $this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod,                             
																			$this->co_reg->db->sqldat($lp_in,'sysapppryapicod'),
                                     	$this->co_reg->db->sqldat($lp_in,'sysappprycod'),
																			$this->co_reg->db->sqldat($lp_in,'sysappapicod'),
                                      $this->co_reg->db->sqldat($lp_in,'sysapppryapicfg',false),
																			$this->co_reg->db->sqldat($lp_in,'docsts'),
																			$this->co_reg->db->sqldat($this->sysdata,'view_options',false),
																		);
    $this->sysdata['sqltxt'] = 'SYS_APP_PRY_API_DEF (?,?,?,?,?,?,?,?,?)';
