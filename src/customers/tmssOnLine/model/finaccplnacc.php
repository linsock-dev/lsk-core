<?php
final class finaccplnacc extends tmssAction {
  /* ----------------------------------------------------
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array(), $lo_vew=null, $lp_authCheck=true ) {
    ...
    $this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			$this->co_reg->db->sqldat($lp_in,'finaccplnacccod'), 
																			$this->co_reg->db->sqldat($lp_in,'finaccplncod'), 
																			$this->co_reg->db->sqldat($lp_in,'finaccplnlvltxt'), 
																			$this->co_reg->db->sqldat($lp_in,'finacccod'), 
																			$this->co_reg->db->sqldat($lp_in,'finaccplnlvl'), 
																			$this->co_reg->db->sqldat($lp_in,'docsts'),
																			$this->co_reg->db->sqldat($this->sysdata,'view_options', false),
																		);
    $this->sysdata['sqltxt'] = 'FIN_ACC_PLN_ACC_DEF (?,?,?,?,?,?,?,?,?,?)';
