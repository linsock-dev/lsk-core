<?php
final class finpaytrmdue extends tmssAction {
  protected $co_reg;
  private $data = array();
	private $sysdata = array();
	const ID = 'paytrmduecod';
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array(), $lo_vew=null ) {
    ...
    $this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			$this->co_reg->db->sqldat($lp_in,'paytrmduecod'), 
																			$this->co_reg->db->sqldat($lp_in,'paytrmcod'), 
																			$this->co_reg->db->sqlnum($lp_in,'paytrmdueamt'), 
																			$this->co_reg->db->sqldat($lp_in,'paytrmduetyp'), 
																			$this->co_reg->db->sqldat($lp_in,'paytrmdueqty'),
																			$this->co_reg->db->sqldat($lp_in,'docsts'),
																			$this->co_reg->db->sqldat($this->sysdata,'view_options',false)
																		);
    $this->sysdata['sqltxt'] = 'FIN_PAY_TRM_DUE_DEF (?,?,?,?,?,?,?,?,?,?)';
