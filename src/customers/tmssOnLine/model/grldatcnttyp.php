<?php
final class grldatcnttyp extends tmssAction {
  protected $co_reg;
  private $data = array();
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array(), $lo_vew=null ) {
	...
	private function call_sp( $lp_action, $lp_in, &$lp_out ) {
		...
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			$this->co_reg->db->sqldat($lp_in,'cnttypcod'), 
																			$this->co_reg->db->sqldat($lp_in,'cnttypcodext'), 
																			$this->co_reg->db->sqldat($lp_in,'cnttyptxt'), 
																			$this->co_reg->db->sqldat($lp_in,'cnttypatr',false),
    ...
    $this->sysdata['sqltxt'] = 'GRL_DAT_CNT_TYP_DEF (?,?,?,?,?,?,?,?,?,?,?,?)';
