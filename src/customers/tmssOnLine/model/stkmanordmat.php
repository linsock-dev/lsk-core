<?php
final class stkmanordmat extends tmssAction {
  protected $co_reg;
  private $data = array();
	private $sysdata = array();
	const ID = 'stkmanordmatcod';
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array(), $lo_vew=null, $lp_authCheck=true ) {
	...
	private function call_sp( $lp_action, $lp_in, &$lp_out ) {
		...
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			$this->co_reg->db->sqldat($lp_in,'stkmanordmatcod'),
                                      ...
                                      $this->co_reg->db->sqldat($lp_in,'stkmanordmatatr'), 
		...
		$this->sysdata['sqltxt'] = 'STK_MAN_ORD_MAT_DEF (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
