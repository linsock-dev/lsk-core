<?php
final class slsprcver extends tmssAction {
  protected $co_reg;
  private $data = array();
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array(), $lo_vew=null ) {
	...
	private function call_sp( $lp_action, $lp_in, &$lp_out ) {
		...
		$this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 
																			...
																			$this->co_reg->db->sqldat($lp_in,'slsprclstancsrc'), 
																			$this->co_reg->db->sqldat($lp_in,'slsprclstancprccod'), 
																			$this->co_reg->db->sqlnum($lp_in,'slsprclstancvar'), 
																			$this->co_reg->db->sqldat($lp_in,'slsprclstancupd'),
																			$this->co_reg->db->sqldat($lp_in,'slsprclstanctyp')
																		);
		$this->sysdata['sqltxt'] = 'SLS_PRC_VER_DEF (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
