<?php
final class logtradlv extends tmssAction {
  protected $co_reg;
  private $data = array();
  ...
  function getList( $lp_vewopt=array(), $lp_prm=array(), $lo_vew=null ) {
    ...
    $this->sysdata['sqlprm'] = array( $lp_action, $this->co_reg->sec->usrcod, $this->co_reg->sec->buscod, 		
																			$this->co_reg->db->sqldat($lp_in,'tradlvcod'), 
																			$this->co_reg->db->sqldat($lp_in,'tracod'), 
																			$this->co_reg->db->sqldat($lp_in,'stkmovdoccod'),  
                                     	$this->co_reg->db->sqldat($lp_in,'tradlvord'),
                                     	$this->co_reg->db->sqldat($lp_in,'tradlvatr'),
																			$this->co_reg->db->sqldat($lp_in,'docsts'),
																			$this->co_reg->db->sqldat($this->sysdata,'view_options',false)
																		);
    $this->sysdata['sqltxt'] = 'LOG_TRA_DLV_DEF (?,?,?,?,?,?,?,?,?,?)';
