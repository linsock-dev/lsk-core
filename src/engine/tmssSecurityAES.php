...
Class tmssSecurityAESctr extends tmssSecurityAES
{
    ...
    public static function encrypt($plaintext, $password, $nBits)
    {
        ...
        $key = tmssSecurityAES::cipher($pwBytes, tmssSecurityAES::keyExpansion($pwBytes));
        ...
        $keySchedule = tmssSecurityAES::keyExpansion($key);
        //print_r($keySchedule);
        ...
        for ($b = 0; $b < $blockCount; $b++) {
            ...
            $cipherCntr = tmssSecurityAES::cipher($counterBlock, $keySchedule); // -- encrypt counter block --
